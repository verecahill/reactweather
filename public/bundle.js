...
/***/ function(module, exports, __webpack_require__) {
	...
	var openWeahterMap = __webpack_require__(221);
	...
	var Weather = React.createClass({
	  ...
	  handleSearch: function handleSearch(location) {
	    ...
	    openWeahterMap.getTemp(location).then(function (temp) {
	      that.setState({
	        location: location,
	        temp: temp,
	        isLoading: false
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=d9ee6be1efb65c140bb01205e3b95cab&units=imperial';
